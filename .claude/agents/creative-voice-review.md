...
- `ai-writing-tells.md` — the written-slop sign families and the false-positive discipline. In a brand brain it lives at `creative-strategy-context/ai-writing-tells.md`; in the factory repo at `global/knowledge/creative-strategy/ai-writing-tells.md`. Glob for it if unsure.
