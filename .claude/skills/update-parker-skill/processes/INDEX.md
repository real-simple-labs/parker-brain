...
| **add-knowledge-doc** | A new top-level reference doc joins the system. Example: `creative-strategy-context/public-ad-library-analysis.md`. | Sketch: write the doc at `parker-v2/[topic]-[shape].md`. Index in `parker-v2/README.md` and the "How to use" section. Add reference paragraphs to every prompt that should load it at runtime. |
