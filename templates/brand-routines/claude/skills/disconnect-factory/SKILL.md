...
- One commit per decoupling. Keep local submodule metadata for recovery; a reconnection needs `git submodule update --init parker-system` after reverting the absorb.
