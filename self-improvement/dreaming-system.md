...
- **The user and the organization — every connected connector.** The day's conversations with Parker first — what the user asked for, corrected, liked, rejected, wondered aloud about, kept coming back to — then every other connector they've linked: work email, Slack, calendar, task manager, Notion, docs, call and meeting transcripts, and the rest. Their real day and the org's real work live across those tools; the fuller the ecosystem dreaming reads each run, the truer it knows the person and the organization, and the more it can tee up. Read them all the same way, closely, for what is genuinely new.
- **The competitors and the landscape.** Sweep the market too, not just the inbox: the tracked competitor ad libraries, the organic niche feeds, and the open web — a competitor's new launch or pricing move, category press, a cultural moment the brand could ride. What changed out there since the last run is as much dreaming's subject as what changed in here.
