...
| **add-knowledge-doc** | A new top-level reference doc joins the system. Example: `global/knowledge/creative-strategy/public-ad-library-analysis.md`. | Sketch: write the doc at `parker-v2/[topic]-[shape].md`. Index in `parker-v2/README.md` and the "How to use" section. Add reference paragraphs to every prompt that should load it at runtime. |
...
| **add-reasoning-move** | A new open-loops reasoning move or senior-strategist prior to capture. | Add it to `global/knowledge/creative-strategy/creative-strategy-fundamentals.md` in the relevant section (priors, posture moves, or failure modes), in brand-agnostic form. |
