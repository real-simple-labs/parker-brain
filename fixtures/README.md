...
- **Supports:** `prompts/ideas-and-briefs/sprint-plan.md` (the concept map it emits) and `global/knowledge/creative-strategy/ideation-and-brainstorming.md` (the concept-planning method).
