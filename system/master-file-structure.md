...
│       ├── .scaffolded                             ← Marker: set up, not built. Written by scripts/scaffold-brain.py, deleted by the build once verification passes; apps read its presence as "not built" (system/brain-scaffold.md)
│       │
