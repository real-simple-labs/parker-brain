...
Backported methodology from a June 2026 buildout that had run ahead of the factory, and closed two factory gaps in the strategy and ideation phases. Source of truth for the new shapes: the private brand brain's `strategy/`, `idea-bank/evaluation-2026-06-18.md`, and `CLAUDE.md` Phase-2/Phase-3 spec.
...
- `content-pipeline/` is brand-specific and was not promoted into the factory.
