...
We will take Laura Geller's account as an example here.

### Slow-burners

Situation: Creative LGL65_B was launched in January, 2025. This ad showed strong performance in the testing phase, with the team allocating it more and more spend over time as the performance was strong. Creative was hitting all KPIs: $30 CPA, significant number of NC Purchases (triple digit), Hook rate over 30%, Hold rate over 10%. In March 2025, Laura Geller media buying team moved the creative to scaling campaigns, where it showed immediate success.
...
Situation: LGL120 was launched in April 2025, and it immediately showed exponential growth in terms of NC Purchases while maintaining on target CPA. Media buyers immediately allocated large amount of money to it (daily budget for it went from $200 daily to $1000 daily in a week), and the creative stood this test as well, continuing to scale. Immediately after it was scaled further in other campaigns, where it continues to show great performance, emerging as the highest spender in the account.
...
For example, we usually don't want to have videos starting with a creator introducing themselves. However, we've had a case in LGL120 where this has been the absolute winner with a hook rate of almost 46%, and we want to make sure that you can spot these patterns and apply them to other iterations as well.

The example for LGL120 is an ad where a creator introduces herself with a classic hook, "Hi, my name is Leslie." Usually, we would try to avoid this type of hook as we've seen in other accounts that it can reduce attention and reduce watch time. But in this case, it was successful. So, we want you to be able to recognize this pattern and recognize if it happened several times in the account. And if that's correct, then you should be able to suggest iterations based on this and not disregard it as a bad hook simply because trends are different in other accounts.
