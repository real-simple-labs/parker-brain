...
- Expert-sourced signals start in `global/knowledge/creative-strategy/expert-insights/`, then route here only once they have become a reusable creative pattern rather than a raw signal.
