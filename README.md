...
Then set up your brand's brain **in Parker Desktop** — the app creates the brain, syncs its folder to your machine, and opens Claude right there to continue the setup.

What happens next: Parker asks a short intake about the things it genuinely can't observe, and builds the brain from your real data — audit first, then strategy, then ideation. The build runs a few hours, mostly on its own; a `BUILD-STATUS.md` file always shows where it is and what's left. Everything saves automatically as it goes — Parker Desktop syncs the folder the whole time — and at the end the standing routines are armed and Parker walks you through what you have.
...
- **Its own repo, separate from this one.** The brand's folder is the whole workspace: the brand's data sits flat at its root, nothing brand-specific ever lands in the factory, and the Parker Desktop app keeps it backed up and synced — Claude never runs git in it.
