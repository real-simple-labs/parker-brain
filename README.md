...
Maintainer guidance — what belongs in this repo, the promotion flow from the private workspace, and the pre-publish checklist — lives in [CONTRIBUTING.md](./CONTRIBUTING.md).
