...
When classifying or comparing ad formats across brands, read `global/knowledge/creative-strategy/ad-formats/` as supporting context. Use it to name formats more precisely while keeping the audit descriptive and market-facing.
