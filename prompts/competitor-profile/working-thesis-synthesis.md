...
- **The open-loops pipeline** — documented in `system/open-loops-system.md`, where this doc's open loops can later be graded, promoted, turned into hypotheses, and validated.
