...
This doc is a Phase-2 synthesis. It does not run until the Phase-1 audit is complete, because the call it makes is only as good as the audit underneath it. The full operating model is in `system/three-phase-operating-model.md`.
